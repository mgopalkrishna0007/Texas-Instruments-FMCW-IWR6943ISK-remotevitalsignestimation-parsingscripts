...
def main():
    ...
    ani = FuncAnimation(fig, animate, fargs=(serial.Serial(comport, baudrate=baudrate, timeout=0.1), scatter, outputDict), interval=100, blit=False)
